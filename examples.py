...
pinterest = Pinterest(email="EvelynLBakerSymbolBlog@outlook.com",
                      password="Savings$2021",
                      username="evelynlbakersymbolblog",
                      cred_root='cred_root')
...
first_interaction(username='evelynlbakersymbolblog',)

boards_res=pinterest.boards_all(username='evelynlbakersymbolblog')
print(boards_res)
