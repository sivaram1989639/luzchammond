...
pinterest = Pinterest(email="MaryRSchmidtgarden@outlook.com",
                      password="Savings$2021",
                      username="maryrschmidtgarden",
                      cred_root='cred_root'
                      ,proxies={"http":"http://13.36.102.214:80"}
                      )
...
def first_interaction(username):
    conn = psycopg2.connect(host="ec2-107-21-10-179.compute-1.amazonaws.com", port = 5432, database="de5q6p72ibhs0c", user="njxjiysfqnydrp", password="343bbd41822484b6676a05c7be5b8db68435fe81d672bed2f63cda484fd15897")
    cur = conn.cursor()
    boards_list_info=[]

    file1 = open("boards_angelajcollinscbshandy.txt","r")
...
first_interaction(username='maryrschmidtgarden',)

boards_res=pinterest.boards_all(username='maryrschmidtgarden')
print(boards_res)
